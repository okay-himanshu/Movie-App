...
function Movies() {
  const { movies, searchCount, isLoading, isNothingFound, isInvalidInput } =
    useGlobalContext();
    ...
    <>
      {isInvalidInput ? 
       ...
       : <>
          ...
          <div className="flex flex-wrap justify-center m-auto sm:justify-start 2xl:mr-96 2xl:ml-96 ">
              ...
              return (
                <div className="mr-5 ml-5 mt-5 mb-5 " key={index}>
                  <div className="wrapper">
                    ...
                    <div className="mt-3">
                      <button
                        onClick={() => handleNavigate(`movies/${imdbID}`)}
